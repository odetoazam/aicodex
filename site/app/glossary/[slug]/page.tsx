...
function RelatedTermCard({ term }: { term: Pick<Term, 'slug' | 'name' | 'cluster'> }) {
...
export default async function TermPage({ params }: { params: { slug: string } }) {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/glossary" style={{ color: 'var(--text-muted)', textDecoration: 'none' }}
      ...
      >
        ...
        <article>
          ...
          {/* Articles for each angle — placeholder */}
            ...
            >
              ...
              <span
                style={{
                  fontFamily: 'var(--font-sans)',
                  fontSize: '14px',
                  color: clusterConfig?.color ?? 'var(--accent)',
                }}
              >
                {term.cluster}
              </span>
          ...
          {relatedTerms.length > 0 && (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column' as const, gap: '6px' }}>
                {relatedTerms.map(t => (
                  <RelatedTermCard key={t.slug} term={t} />
                ))}
              </div>
            </div>
          )}
