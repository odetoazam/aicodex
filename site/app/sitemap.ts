...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE}/learn/getting-your-team-started`, changeFrequency: 'yearly', priority: 0.4 },
  { url: `${BASE}/learn/build-with-ai`, changeFrequency: 'monthly', priority: 0.7 },
  { url: `${BASE}/articles`, changeFrequency: 'weekly', priority: 0.85 },
  { url: `${BASE}/academy`, changeFrequency: 'monthly', priority: 0.85 },
  { url: `${BASE}/learn/agent-manager`, changeFrequency: 'monthly', priority: 0.85 },
  { url: `${BASE}/learn/forward-deployed-engineer`, changeFrequency: 'monthly', priority: 0.85 },
  { url: `${BASE}/learn/internal-ai-stack`, changeFrequency: 'monthly', priority: 0.8 },
  ...
  { url: `${BASE}/compare/claude-vs-gpt5-customer-support`, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/compare/claude-vs-gpt5-coding`, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/compare/claude-vs-gpt5-writing`, changeFrequency: 'monthly', priority: 0.8 },
  { url: `${BASE}/compare/claude-vs-gpt5-document-analysis`, changeFrequency: 'monthly', priority: 0.8 },
