...
const STAGES = [
  {
    ...
    steps: [
      {
        number: 1,
        concept: 'Should we use Claude?',
        conceptSlug: 'claude-plans',
        articleSlug: 'running-your-first-ai-pilot',
        label: 'The honest evaluation',
        takeaway: 'How to assess whether Claude will deliver real value for your organization — what questions to ask before you commit, and how to scope a pilot that gives you a real answer.',
        time: '6 min',
      },
      {
        number: 2,
        ...
        takeaway: 'The difference between Free, Pro, Team, and Enterprise — what you actually get at each tier, when to upgrade, and what to consider if you\'re buying for more than 10 people.',
        time: '5 min',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        label: 'Configuring Projects per team function',
        takeaway: 'How to set up separate Projects for CS, ops, sales, and marketing — each with its own system prompt and knowledge base — so every team gets a Claude tuned to their work.',
        time: '5 min',
      },
      {
        number: 5,
