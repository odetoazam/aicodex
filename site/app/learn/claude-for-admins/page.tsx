      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ fontFamily: 'var(--font-sans)', fontSize: '14px', color: 'var(--text-secondary)', margin: 0, lineHeight: 1.5 }}>
            Anthropic offers a free <strong>Claude for Enterprise</strong> module with video + certificate — covers security, compliance, and admin controls from Anthropic's own team.
          </p>
        </div>
        <a
