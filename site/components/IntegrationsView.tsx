...
const INTEGRATIONS: Record<string, Integration> = {
  ...
  'excel-skill': {
    ...
    verdict: 'essential',
    verdictNote: 'Changes what Claude can do for anyone who works with spreadsheets.',
...
const STACKS: Stack[] = [
  {
    ...
    caveat: "Projects + Google Drive is the combination that delivers. The skills are high value if you regularly produce documents or work with spreadsheets — skip them otherwise.",
  },
  {
    role: 'marketing',
    ...
    caveat: "The Projects + Web Search combination is the core. Research mode is genuinely useful for competitive work — use it for questions worth doing properly, not quick lookups.",
  },
  {
    role: 'cs',
    ...
    caveat: "Slack + Projects is the combination that changes daily workflow. The value of the Slack connector depends entirely on how much your team actually lives in Slack — if it's mostly social, skip it.",
  },
  {
    role: 'founder',
  ...
  },
  {
    ...
    caveat: "GitHub + Context7 is the foundation. The rest depends on your stack — Playwright only matters for frontend testing, Jira only matters if you're managing a team or sprint.",
  },
]
