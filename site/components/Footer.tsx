...
const FOOTER_LINKS = {
  ...
  'Compare': [
    { label: 'Claude vs GPT-5.6: Support', href: '/compare/claude-vs-gpt5-customer-support' },
    { label: 'Claude vs GPT-5.6: Coding', href: '/compare/claude-vs-gpt5-coding' },
    { label: 'Claude vs GPT-5.6: Writing', href: '/compare/claude-vs-gpt5-writing' },
    { label: 'Claude vs GPT-5.6: Documents', href: '/compare/claude-vs-gpt5-document-analysis' },
    { label: 'Haiku vs Sonnet', href: '/compare/claude-haiku-vs-sonnet' },
  ],
  'Learn': [
    { label: 'Learning paths', href: '/learn' },
    { label: 'Claude Academy guide', href: '/academy' },
